...
<head>
    ...
    <link rel="stylesheet" href="https://htmldemo.net/boighor/boighor/css/plugins.css">
    <link rel="stylesheet" href="https://htmldemo.net/boighor/boighor/css/plugins/fotorama.css">
    <link rel="stylesheet" href="https://htmldemo.net/boighor/boighor/css/custom.css">
                    ...
                    <div class="col-lg-8 d-none d-lg-block">
                        <nav class="mainmenu__nav">
                            <ul class="meninmenu d-flex justify-content-start">
                                <li class="drop with--one--item" style="position: relative;"><a href="index.php">Home</a>
                ...
                <div class="row">
                    <div class="col-lg-9 col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="wn__fotorama__wrapper">
                                        <style>
                                            .fotorama1691591018202 .fotorama__nav--thumbs .fotorama__nav__frame {
                                                padding: 2px;
                                                height: 64px
                                            }

                                            .fotorama1691591018202 .fotorama__thumb-border {
                                                height: 60px;
                                                border-width: 2px;
                                                margin-top: 2px
                                            }
                                        ...
                                        <div class="fotorama wn__fotorama__action fotorama1691591018202" data-nav="thumbs">
                                            <div class="fotorama__wrap fotorama__wrap--css3 fotorama__wrap--slide fotorama__wrap--toggle-arrows fotorama__wrap--no-controls" style="width: 450px; min-width: 0px; max-width: 100%;">
                                                <div class="fotorama__stage fotorama__pointer" style="width: 332px; height: 417px;">
                                                    <div class="fotorama__stage__shaft" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); width: 332.25px; margin-left: 0px;">
                                                        <div class="fotorama__stage__frame fotorama__loaded fotorama__loaded--img fotorama__active" style="left: 0px;"><img src="<?= $book->coverImg ?>" class="fotorama__img"></div>
                                                        <div class="fotorama__stage__frame fotorama__loaded fotorama__loaded--img" style="left: 334.25px;"><img src="images/product/2.jpg" class="fotorama__img"></div>
                                                    </div>
                                                ...
                                                <!-- <div class="fotorama__nav-wrap">
                                                    <div class="fotorama__nav fotorama__nav--thumbs fotorama__shadows--right" style="width: 332.25px;">
                                                        <div class="fotorama__nav__shaft fotorama__grab" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                                            ...
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb fotorama__active" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/1.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/2.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/3.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/4.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/5.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/6.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb fotorama__loaded fotorama__loaded--img"><img src="images/product/7.jpg" class="fotorama__img" style="width: 64px; height: 80.3556px; left: 0px; top: -8.17778px;"></div>
                                                            </div>
                                                            <div class="fotorama__nav__frame fotorama__nav__frame--thumb" tabindex="0" role="button" style="width: 64px;">
                                                                <div class="fotorama__thumb"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> -->
                                    ...
                                    <div class="product__info__main">
                                        ...
                                        <div class="product-reviews-summary d-flex">
                                            <ul class="rating-summary d-flex">
                                                <?php
                                                // $roundedRating = round($book->rating, 0);
                                                $roundedRating = intval($book->rating);
                                                switch ($roundedRating) {
                                                    case 1:
                                                        echo '<li class="on"><i class="zmdi zmdi-star-outline"></i></li>
                                            ...
                                            <span><?= "(" . $book->rating . ") - " . $book->numRatings . " avis" ?></span>
                                        </div>
                                        <div class="price-box">
                                            <span>$52.00</span>
                                        </div>
                                        ...
                                        <div class="product_meta">
                                            <span class="posted_in">Categories:
                                                ...
                                                foreach ($book->genres as $key => $value) {
                                                    echo "<a href='index.php?genreName=$value'>$value</a>, ";
                                                }
                                                ?>
                                            </span>
                                        </div>
                        ...
                        <div class="wn__related__product pt--80 pb--50">
                            ...
                            <div class="row mt--60">
                                <div class="productcategory__slide--2 arrows_style owl-carousel owl-theme owl-loaded owl-drag">
                                    ...
                                    <div class="owl-stage-outer">
                                        <div class="owl-stage" style="transform: translate3d(-724px, 0px, 0px); transition: all 0s ease 0s; width: 2898px;">
                                            <div class="owl-item cloned" style="width: 211.5px; margin-right: 30px;">
